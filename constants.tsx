...
export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 1, title: "Bus Delay", message: "Bus-001 is running 15 minutes late due to traffic.", date: "2024-07-29", bus_id: 1, target_roles: ['student', 'admin'] },
    { id: 2, title: "Route Change", message: "Route A will have a detour tomorrow near City Park.", date: "2024-07-28", target_roles: ['student', 'admin'] },
    { id: 3, title: "Holiday Schedule", message: "Buses will operate on a holiday schedule next Monday.", date: "2024-07-27", target_roles: ['student', 'admin'] },
];
